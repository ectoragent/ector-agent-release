...
# Load GGUF model
lm = LlamaCpp(
    model_path="/path/to/provider.gguf",
...
lm = LlamaCpp("/path/to/provider.Q4_K_M.gguf")

# Q5_K_M (5-bit, better quality)
lm = LlamaCpp("/path/to/provider.Q5_K_M.gguf")

# Q8_0 (8-bit, high quality)
lm = LlamaCpp("/path/to/provider.Q8_0.gguf")

# F16 (16-bit float, highest quality)
lm = LlamaCpp("/path/to/provider.F16.gguf")
```
...
# Maximize GPU layers
lm = LlamaCpp(
    model_path="/path/to/provider.Q4_K_M.gguf",
