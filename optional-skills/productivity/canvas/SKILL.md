...
4. Name the token (e.g., "Ector Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.ector/.env`:
...
```bash
CANVAS="python $ECTOR_HOME/skills/productivity/canvas/scripts/canvas_api.py"
