...
Data file: $ECTOR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ECTOR_HOME = Path(os.environ.get("ECTOR_HOME", Path.home() / ".ector"))
DATA_DIR = _ECTOR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
