"""
Skills configuration for Ector Agent.
`ector skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.ector/config.yaml under:
...
from ector_cli.platforms import PLATFORMS as _PLATFORMS
