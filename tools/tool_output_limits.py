...
Ported from a public implementation (``feat(truncate): allow
configuring tool output truncation limits``).

The upstream implementation hardcoded ``MAX_LINES = 2000`` and ``MAX_BYTES = 50 * 1024``
as tool-output truncation thresholds. Ector-agent had the same
