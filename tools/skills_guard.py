...
Trust levels:
  - builtin:   Ships with Ector. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.ector/\.env|\~/\.ector/\.env',
     "ector_env_access", "critical", "exfiltration",
     "directly references Ector secrets file"),
    ...
    (r'\.ector/config\.yaml|\.ector/SOUL\.md',
     "ector_config_mod", "critical", "persistence",
     "references Ector configuration files directly"),
