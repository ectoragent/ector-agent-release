...
# Other display settings (personality, skin, etc.) are CLI-only
...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # "new"/"all" spam permanent lines in channels (ector-agent#14663).
    "slack": {**_TIER_MEDIUM, "tool_progress": "off"},

    # WhatsApp bridge supports /edit on some clients
