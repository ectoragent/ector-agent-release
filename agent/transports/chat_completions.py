...
providers (OpenRouter, Ector, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params:
            ...
            # Claude on OpenRouter/Ector max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Ector, OpenRouter,
        ...
        is_ector_host = params.get("is_ector_host", False)
        ...
        if params.get("supports_reasoning", False):
            if is_github_models:
                ...
                if reasoning_config is not None:
                    ...
                    if is_ector_host and rc.get("enabled") is False:
                        pass  # omit for Ector when disabled
                    else:
        ...
        if is_ector_host:
            extra_body["tags"] = ["product=ector-agent"]
