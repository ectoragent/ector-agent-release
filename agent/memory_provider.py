...
External provider plugins are additive — they never
...
class MemoryProvider(ABC):
    ...
    @abstractmethod
    def name(self) -> str:
        """Short identifier for this provider (e.g. 'builtin' or the plugin id)."""
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - ector_home (str): The active ECTOR_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.ector``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "ector").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'ector memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], ector_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'ector memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``ector_home`` is the active ECTOR_HOME directory path.
