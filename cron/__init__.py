"""
Cron job scheduling system for Ector Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    ector gateway install    # Install as a user service
    sudo ector gateway install --system  # Linux servers: boot-time system service
    ector gateway            # Or run in foreground
