...
slash command, every approval/Wiser (wiser)/sudo flow, and every agent event flows
...
async def handle_ws(ws: Any) -> None:
    ...
    from tui_gateway.entry import _gateway_ready_payload

    ready_payload: Dict[str, Any] = _gateway_ready_payload()
